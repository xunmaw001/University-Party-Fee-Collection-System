    ...
    <view class="content">
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#543622","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                     class="li" hover-class="hover">
                  <view class="text" :style='{"color":"#6a4826","fontSize":"28rpx"}'>用户充值</view>
                  <!-- <image class="to" :style='{"color":"#6a4826","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                  <view class="cuIcon-right" :style='{"color":"#6a4826","fontSize":"28rpx"}'></view>
              </view>
                ...
                <view v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <view v-bind:key="sort" v-for=" (child,sort) in menu.child">
                        <view
                                ...
                                hover-class="hover">
                            <view :style='{"color":"#6a4826","fontSize":"28rpx"}' class="text">
                                {{child.menu}}</view>
                            <view class="cuIcon-right" :style='{"color":"#6a4826","fontSize":"28rpx"}'>
                            </view>
                        </view>
                    </view>
                </view>
			...
			<view @tap="onPageTap('../forum/forum-my')"
                  :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#543622","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                  class="li" hover-class="hover">
                <view class="text" :style='{"color":"#6a4826","fontSize":"28rpx"}'>我的发贴</view>
                <!-- <image class="to" :style='{"color":"#6a4826","fontSize":"28rpx"}' src="/static/center/to.png"></image> -->
                <view class="cuIcon-right" :style='{"color":"#6a4826","fontSize":"28rpx"}'></view>
            </view>
