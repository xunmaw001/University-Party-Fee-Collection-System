	...
	<view class="content">
		<view class="logo" v-if="true">
			<image
				...
				src='http://localhost:8080/gaoxiaodangfeishoujiao/img/logo.jpg' mode="aspectFill">
			</image>
		</view>
		...
		<view>
			<button @tap="register" type="primary"
				:style='{"borderColor":"rgba(254, 254, 254, 1)","backgroundColor":"#6a4826","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"0px","fontSize":"32rpx","borderStyle":"solid","height":"90rpx"}'>注册</button>
		</view>
	</view>
</template>
