    		...
    		<view class="container">
                <view class="detail-content">
                    <view class="detail-list-item"
                          :style='{"boxShadow":"0 0 10rpx rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"#6a4826","backgroundColor":"#fff","borderRadius":"10rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
                        <view class="lable"
                              :style='{"width":"auto","fontSize":"28rpx","color":"#6a4826","textAlign":"left"}'>
                            标题：</view>
                        <view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.gonggaoName}}
                        </view>
                    </view>
                </view>
                <view class="time-content"
                      :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"#6a4826","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"100%"}'
                      style="height:auto !important;">
                    <view class="header" :style='{"color":"#6a4826","fontSize":"28rpx"}'>
                        内容
                    </view>
                    <view class="content" :style='{"color":"#333","fontSize":"28rpx"}'>
                        <rich-text style="font-size: 33upx;line-height: 50upx;letter-spacing: 5upx;"
                                   :nodes="detail.gonggaoContent"></rich-text>
                    </view>
                </view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('gonggao', this.id);
