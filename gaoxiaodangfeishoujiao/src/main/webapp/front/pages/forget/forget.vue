    ...
    <view class="content">
                ...
                <view class="login-input login-margin-b">
                    <picker style="color: #888888;padding: 0 40upx;box-sizing:border-box;margin-top: 20upx;"
                        ...
                        <view class="uni-input"
                              :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"#6a4826","textAlign":"center"}'>
                            {{options[index]}}</view>
                    </picker>
                </view>
            </view>
        ...
        <view class="forget-btn">
            <button class="landing"
                    :style='{"borderColor":"#ccc","backgroundColor":"#6a4826","borderRadius":"8rpx","color":"rgba(255, 255, 255, 1)","borderWidth":"2rpx","fontSize":"32rpx","borderStyle":"solid","height":"88rpx"}'
